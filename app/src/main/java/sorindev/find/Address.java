...
public class Address {
    ...
    public Address(int index, String nume, String meniu, int meniul_zileiA, String meniul_zilei, String date_contact, int non_stop, float latit, float longit, int status ){
        this.index = index;
        this.nume = nume;
        this.meniu = meniu;
